...
export class CreateRecurrentRecord1632078609589 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('ALTER TABLE `recurrent_record` DROP FOREIGN KEY `FK_88f02d1fd5a9d3a3c7716826359`');
        await queryRunner.query('ALTER TABLE `recurrent_record` DROP FOREIGN KEY `FK_796041f90cdbd25cbe37994ffce`');
        await queryRunner.query('ALTER TABLE `recurrent_record` DROP FOREIGN KEY `FK_08e81bbe8f256196b9f150aabaa`');
