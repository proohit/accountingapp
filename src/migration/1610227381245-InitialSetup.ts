...
export class InitialSetup1610227381245 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('ALTER TABLE `record` DROP FOREIGN KEY `FK_73168a64f6e1844723c2b180cee`');
        await queryRunner.query('ALTER TABLE `record` DROP FOREIGN KEY `FK_0f300ebe5dabbe0fc7f5a413c1b`');
        await queryRunner.query('ALTER TABLE `record` DROP FOREIGN KEY `FK_3d741463341d2bc1bba71f9a4ab`');
        await queryRunner.query('ALTER TABLE `wallet` DROP FOREIGN KEY `FK_3aebcdeaeb1ab5df40570c3a026`');
        await queryRunner.query('ALTER TABLE `category` DROP FOREIGN KEY `FK_142b9fbfe3a56a90ae45f102230`');
